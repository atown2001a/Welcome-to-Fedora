...
- Jane can comment on the ticket whenever she needs to---to ask questions, to give feedback, or just to chat. When Jane needs a response, she can use the [C: Needs response](https://pagure.io/fedora-join/Welcome-to-Fedora/issues?tags=C%3A+Needs+response) tag to gain the community's attention.
